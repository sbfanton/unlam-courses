...
int main()
{
    ...
    printf("\n\nOrdenamiento por seleccion usando qsort");
    ...
    qsort(numerosEnteros,ceEnteros,sizeof(numerosEnteros[0]),compararEntero);
    ...
    for(int i = 0; i < ceEnteros; i++){
     ...
     qsort(personas, cePersonas, sizeof(personas[0]), compararPersonaDni);
     ...
     qsort(personas, cePersonas, sizeof(personas[0]), compararPersonaApellidoYNombre);
     ...
     qsort(personas, cePersonas, sizeof(personas[0]), compararPersonaPeso);
